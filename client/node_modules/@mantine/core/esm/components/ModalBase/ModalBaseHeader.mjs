...
import cx from 'clsx';
import classes from './ModalBase.module.mjs';
...
const ModalBaseHeader = forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React.createElement(Box, __spreadValues({ ref, className: cx({ [classes.header]: !ctx.unstyled }, className) }, others));
  }
);
