...
const MenuTarget = forwardRef((props, ref) => {
  const _a = useProps("MenuTarget", defaultProps, props), { children, refProp } = _a, others = __objRest(_a, ["children", "refProp"]);
  ...
  return /* @__PURE__ */ React.createElement(Popover.Target, __spreadValues({ refProp, popupType: "menu", ref }, others), cloneElement(children, {
    onClick,
    onMouseEnter,
    onMouseLeave,
