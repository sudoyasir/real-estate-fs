...
import classes from './Notification.module.mjs';
...
const Notification = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", __spreadValues({}, getStyles("body")), title && /* @__PURE__ */ React.createElement("div", __spreadValues({}, getStyles("title")), title), /* @__PURE__ */ React.createElement(Box, __spreadProps(__spreadValues({}, getStyles("description")), { mod: { "data-with-title": !!title } }), children)),
