...
const RangeSlider = factory.factory((_props, ref) => {
  ...
  ), /* @__PURE__ */ React__default.createElement("input", __spreadValues({ type: "hidden", name: `${name}_from`, value: _value[0] }, hiddenInputProps)), /* @__PURE__ */ React__default.createElement("input", __spreadValues({ type: "hidden", name: `${name}_to`, value: _value[1] }, hiddenInputProps))));
});
