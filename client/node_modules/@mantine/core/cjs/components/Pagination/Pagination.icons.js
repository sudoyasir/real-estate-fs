...
function PaginationIcon(_a) {
  ...
  return /* @__PURE__ */ React__default.createElement(
    ...
    /* @__PURE__ */ React__default.createElement("path", { d: path, fill: "currentColor" })
  );
}
const PaginationNextIcon = (props) => /* @__PURE__ */ React__default.createElement(
  PaginationIcon,
  __spreadProps(__spreadValues({}, props), {
    path: "M8.781 8l-3.3-3.3.943-.943L10.667 8l-4.243 4.243-.943-.943 3.3-3.3z"
  })
);
const PaginationPreviousIcon = (props) => /* @__PURE__ */ React__default.createElement(
  PaginationIcon,
  __spreadProps(__spreadValues({}, props), {
    path: "M7.219 8l3.3 3.3-.943.943L5.333 8l4.243-4.243.943.943-3.3 3.3z"
  })
);
const PaginationFirstIcon = (props) => /* @__PURE__ */ React__default.createElement(
  PaginationIcon,
  __spreadProps(__spreadValues({}, props), {
...
const PaginationLastIcon = (props) => /* @__PURE__ */ React__default.createElement(
  PaginationIcon,
  __spreadProps(__spreadValues({}, props), {
...
const PaginationDotsIcon = (props) => /* @__PURE__ */ React__default.createElement(
  PaginationIcon,
  __spreadProps(__spreadValues({}, props), {
