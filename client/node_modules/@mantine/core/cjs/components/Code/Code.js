...
var Code_module = require('./Code.module.css.js');
...
const Code = factory.factory((_props, ref) => {
  ...
  const _a = props, { classNames, className, style, styles, unstyled, vars, color, block, variant } = _a, others = __objRest(_a, ["classNames", "className", "style", "styles", "unstyled", "vars", "color", "block", "variant"]);
  const getStyles = useStyles.useStyles({
    name: "Code",
    props,
    classes: Code_module['default'],
    className,
    style,
    classNames,
    styles,
...
Code.classes = Code_module['default'];
