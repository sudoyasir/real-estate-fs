...
const ModalBaseHeader = React.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React__default.createElement(Box.Box, __spreadValues({ ref, className: cx__default({ [ModalBase_module['default'].header]: !ctx.unstyled }, className) }, others));
  }
);
