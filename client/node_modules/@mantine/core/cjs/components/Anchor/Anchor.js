...
const Anchor = polymorphicFactory.polymorphicFactory((props, ref) => {
  const _a = useProps.useProps("Anchor", defaultProps, props), { underline, className, unstyled } = _a, others = __objRest(_a, ["underline", "className", "unstyled"]);
  return /* @__PURE__ */ React__default.createElement(
    Text.Text,
    __spreadProps(__spreadValues({
      component: "a",
      ref,
      className: cx__default({ [Anchor_module['default'].root]: !unstyled }, className)
    }, others), {
      mod: { underline },
