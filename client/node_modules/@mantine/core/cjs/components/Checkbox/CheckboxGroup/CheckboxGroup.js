...
const CheckboxGroup = factory.factory((props, ref) => {
  ...
  return /* @__PURE__ */ React__default.createElement(CheckboxGroup_context.CheckboxGroupProvider, { value: { value: _value, onChange: handleChange, size } }, /* @__PURE__ */ React__default.createElement(
    Input.Input.Wrapper,
    ...
    /* @__PURE__ */ React__default.createElement(InputsGroupFieldset.InputsGroupFieldset, { role: "group" }, children)
  ));
});
