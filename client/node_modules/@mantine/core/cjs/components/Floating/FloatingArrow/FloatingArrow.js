...
var getArrowPositionStyles = require('./get-arrow-position-styles.js');
  ...
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React__default.createElement(
      ...
      __spreadProps(__spreadValues({}, others), {
        ref,
        style: __spreadValues(__spreadValues({}, style), getArrowPositionStyles.getArrowPositionStyles({
          position,
          arrowSize,
          arrowOffset,
          arrowRadius,
